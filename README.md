...
The GNOME Extensions GUI (`gnome-extensions-app`) is installed on every distro,
so the user can install any other extension themselves from the Extensions app.
...
| GNOME Extensions GUI | `gnome-shell-extensions` | `gnome-extra/gnome-shell-extensions` |
